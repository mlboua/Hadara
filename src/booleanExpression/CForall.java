 ...
 * Time: 18:29
 */
public class CForall extends CBooleanExpression
{
    ArrayList<CVariable> m_Variables;
    CMutableTreeNode m_VariablesNode;
    CBooleanExpression m_Element;
    public CForall(CBooleanExpression Element,CVariable ... Variables)
    {
        super();
    ...
    public CForall(CBooleanExpression Element,ArrayList<CVariable> Variables)
    {
        super();
        this.m_Element = Element;
        this.add(this.m_Element);
